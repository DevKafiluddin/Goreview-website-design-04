import {a as e, c as t, d as n, i as r, l as i, n as a, o, r as s, s as c, u as l} from "./config-BUHTk5A2.js";
(function() {
...
function g(e) {
    try {
        let t = e.find(e => e instanceof Error);
        if (t && t.stack)
            p({
                type: `console.error`,
                args: t
            ...
            let t = e.map(e => typeof e == `object` ? JSON.stringify(e) : String(e)).join(` `);
            p({
                type: `console.error`,
                args: Error(t)
            })
...
;
function _() {
    return window.removeEventListener(`error`, m),
...
var v = 1e3
  , y = Symbol(`postMessageResponseTimeout`)
  , b = 0
  , x = `*`
  , ee = class {
    constructor(e, t) {
    ...
    destroy() {
        this.clear(),
        this.removeListeners.forEach(e => e())
    }
    isTimeout(e) {
        return e === y
    }
    post(e, t, n) {
        ...
        new Promise(e => {
            this.waitRes.set(b, t => {
                e(t)
            }
            ),
            setTimeout( () => {
                this.waitRes.delete(b),
                e(y)
            }
            , r || this.baseTimeout)
        }
    ...
    on(e, t, n) {
        let {once: r, origin: i=x} = n || {}
          , a = async n => {
            let {id: a, type: s, data: c} = n.data, l;
            s === e && (l = await t(c),
            console.log(e, r, l, c),
            (a && i === n.origin || i === x) && n.source?.postMessage({
                fromType: e,
                id: a,
                data: l
            }, n.origin),
        ...
        let o = () => {
            ...
            this.removeListeners.delete(o)
        }
        ;
        return this.removeListeners.add(o),
        o
    }
    emitResponse(e) {
        let {id: t, data: n} = e.data
          , r = this.waitRes.get(t);
        r && r(n)
    }
}
  , te = new class {
    ...
    #r = !1;
    constructor() {
        this.#t = HTMLElement.prototype.addEventListener,
        this.#n = HTMLElement.prototype.removeEventListener
    }
    patch() {
        if (this.#r)
            return;
        let e = this;
        HTMLElement.prototype.addEventListener = function(t, n, r) {
            return e.#i(this, t, n),
            e.#t.call(this, t, n, r)
        }
        ,
        HTMLElement.prototype.removeEventListener = function(t, n, r) {
            return e.#a(this, t, n),
            e.#n.call(this, t, n, r)
        }
        ,
    ...
    unpatch() {
        this.#r && (HTMLElement.prototype.addEventListener = this.#t,
        HTMLElement.prototype.removeEventListener = this.#n,
        this.#r = !1,
    ...
    hasListeners(e, t) {
        let n = this.#e.get(e);
        return !n || n.size === 0 ? !1 : t ? t.some(e => {
            let t = n.get(e);
            return t && t.size > 0
        }
        ) : !0
    ...
    getElementDebugInfo(e) {
        ...
        return t ? {
            ...
            totalListeners: Array.from(t.values()).reduce( (e, t) => e + t.size, 0)
        } : {
            element: e,
            hasListeners: !1,
            eventTypes: [],
  ...
  , ne = [`click`, `dblclick`, `contextmenu`, `mousedown`, `mouseup`, `mousemove`, `mouseenter`, `mouseleave`, `mouseover`, `mouseout`, `touchstart`, `touchmove`, `touchend`, `touchcancel`, `pointerdown`, `pointerup`, `pointermove`, `pointerenter`, `pointerleave`, `pointerover`, `pointerout`, `pointercancel`];
function re(e) {
    return te.hasListeners(e, ne)
}
function S(e) {
    return te.getEventTypes(e).filter(e => ne.includes(e))
}
function ie(e) {
    let t = S(e)
      , n = {};
    return t.forEach(t => {
        n[t] = te.getListenerCount(e, t)
    }
    ),
    {
...
function ae(e) {
    return te.getElementDebugInfo(e)
}
function oe(e=window) {
    te.patch(),
    e.__eventListenerRegistry__ = {
        hasListeners: re,
        getEventTypes: S,
        getDetail: ie,
        getDebugInfo: () => te.getDebugInfo(),
        getElementDebugInfo: ae
    },
    console.log(`[EnhancedEventDetector] ✅ Initialized and patched addEventListener`)
}
typeof window < `u` && oe(window);
var se = [`onClick`, `onDoubleClick`, `onContextMenu`, `onMouseDown`, `onMouseUp`, `onPointerDown`, `onPointerUp`, `onTouchStart`, `onTouchEnd`, `onDragStart`, `onDrop`, `onChange`, `onSubmit`, `onKeyDown`, `onKeyUp`];
function ce(e) {
    let t = Object.keys(e).find(e => e.startsWith(`__reactFiber$`) || e.startsWith(`__reactInternalInstance$`));
    return t ? e[t] : null
}
function le(e) {
    return !e || typeof e != `object` ? !1 : se.some(t => typeof e[t] == `function`)
}
function ue(e) {
    return !e || typeof e != `object` ? [] : se.filter(t => typeof e[t] == `function`)
}
function C(e) {
    let t = ce(e);
    for (; t; ) {
        if (t.memoizedProps && le(t.memoizedProps))
            return !0;
        t = t.return || null
    }
    return !1
...
function w(e) {
    ...
    for (; n; ) {
        if (n.memoizedProps) {
            let e = ue(n.memoizedProps);
            if (e.length > 0) {
                t.hasEvents = !0;
                let r = n.type?.displayName || n.type?.name || n.elementType?.name || `Unknown`;
                t.events.push({
                    componentName: r,
                    eventNames: e,
...
function de(e) {
    let t = ce(e);
    return !t || !t.memoizedProps ? !1 : le(t.memoizedProps)
}
function fe(e=window) {
    e.__reactEventDetector__ = {
        hasReactInteractionEvents: C,
        getReactInteractionEventsDetail: w,
        hasReactInteractionEventsOnSelf: de,
        REACT_EVENT_PROPS: se
    },
...
function me(e) {
    return e ? de(e) || re(e) : !1
}
function T(e) {
    let t = w(e)
      , n = ie(e);
    return {
        hasEvents: t.hasEvents || n.hasEvents,
        react: t,
        native: n
    }
}
...
function ye() {
    window.__interactionDetector__ = {
        hasInteractionEvents: pe,
        hasInteractionEventsOnSelf: me,
        getDetail: T,
        checkBySelector: E,
        checkByPoint: he,
        checkMultiple: ge,
        checkMultipleSelectors: _e,
        version: ve
    },
    console.log(`[InteractionDetector] Global API initialized (v${ve})`)
}
function be() {
    let e = new ee(window.parent);
    e.on(`checkInteraction`, e => {
        let {selector: t, x: n, y: r} = e || {};
        return t ? E(t) : typeof n == `number` && typeof r == `number` ? he(n, r) : {
            error: `Invalid params: need selector or (x, y)`
        }
    }
    ),
    e.on(`checkMultipleSelectors`, e => {
        let {selectors: t} = e || {};
...
var Se = i((e => {
  ...
  , Te = i(( (e, t) => {
    t.exports = typeof URL == `function` ? URL : we().URL
}
))
  , Ee = i((e => {
    var t = Te();
    ...
    function l(e, t) {
        ...
        return n !== 0 || (n = e.generatedColumn - t.generatedColumn,
        n !== 0) || (n = c(e.source, t.source),
        n !== 0) || (n = e.originalLine - t.originalLine,
        n !== 0) || (n = e.originalColumn - t.originalColumn,
        n !== 0) ? n : c(e.name, t.name)
    }
    e.compareByGeneratedPositionsInflated = l;
    function u(e) {
    ...
    function f(e) {
        return n => {
            ...
            e(a);
            let o = a.toString();
            return r === `absolute` ? o : r === `scheme-relative` ? o.slice(5) : r === `path-absolute` ? o.slice(d.length) : v(i, o)
        }
    }
    function p(e, n) {
        return new t(e,n).toString()
    }
    function m(e, t) {
        let n = 0;
        do {
    ...
    var g = /^[A-Za-z0-9\+\-\.]+:/;
    function _(e) {
        return e[0] === `/` ? e[1] === `/` ? `scheme-relative` : `path-absolute` : g.test(e) ? `absolute` : `path-relative`
    }
    function v(e, n) {
        typeof e == `string` && (e = new t(e)),
        typeof n == `string` && (n = new t(n));
        let r = n.pathname.split(`/`)
          , i = e.pathname.split(`/`);
        for (i.length > 0 && !i[i.length - 1] && i.pop(); r.length > 0 && i.length > 0 && r[0] === i[0]; )
            r.shift(),
            i.shift();
        return i.map( () => `..`).concat(r).join(`/`) + n.search + n.hash
    }
    var y = f(e => {
      ...
      , b = f(e => {
        e.href = new t(`.`,e.toString()).toString()
    }
    )
      , x = f(e => {}
    );
    ...
    function ee(e, t) {
        ...
        if (r === `absolute`)
            return p(t, e);
        if (n === `scheme-relative`)
            return x(t);
        if (r === `scheme-relative`)
            return p(t, p(e, d)).slice(5);
        if (n === `path-absolute`)
            return x(t);
        if (r === `path-absolute`)
            return p(t, p(e, d)).slice(d.length);
        let i = h(t + e);
        return v(i, p(t, p(e, i)))
    }
    e.join = ee;
    function te(e, t) {
        let n = ne(e, t);
        return typeof n == `string` ? n : x(t)
    }
    e.relative = te;
    function ne(e, n) {
        if (_(e) !== _(n))
        ...
        return a.protocol !== i.protocol || a.user !== i.user || a.password !== i.password || a.hostname !== i.hostname || a.port !== i.port ? null : v(i, a)
    }
    function re(e, t, n) {
        e && _(t) === `path-absolute` && (t = t.replace(/^\//, ``));
        let r = x(t || ``);
        return e && (r = ee(e, r)),
        n && (r = ee(b(n), r)),
        r
    }
    e.computeSourceURL = re
}
))
  , De = i((e => {
    e.ArraySet = class e {
      ...
      , a = class e {
        ...
        static fromSourceMap(t) {
            ...
            return t.eachMapping(function(e) {
                ...
                e.source != null && (t.source = e.source,
                r != null && (t.source = n.relative(r, t.source)),
                t.original = {
                    line: e.originalLine,
            ...
            t.sources.forEach(function(e) {
                let a = e;
                r != null && (a = n.relative(r, e)),
                i._sources.has(a) || i._sources.add(a);
                let o = t.sourceContentFor(e);
                o != null && i.setSourceContent(e, o)
            }),
            i
        }
        addMapping(e) {
            let t = n.getArg(e, `generated`)
              , r = n.getArg(e, `original`, null)
              , i = n.getArg(e, `source`, null)
              , a = n.getArg(e, `name`, null);
            this._skipValidation || this._validateMapping(t, r, i, a),
            i != null && (i = String(i),
        ...
        setSourceContent(e, t) {
            let r = e;
            this._sourceRoot != null && (r = n.relative(this._sourceRoot, r)),
            t == null ? this._sourcesContents && (delete this._sourcesContents[n.toSetString(r)],
            Object.keys(this._sourcesContents).length === 0 && (this._sourcesContents = null)) : (this._sourcesContents ||= Object.create(null),
            this._sourcesContents[n.toSetString(r)] = t)
        }
        applySourceMap(e, t, i) {
            let a = t;
            if (t == null) {
                if (e.file == null)
            ...
            o != null && (a = n.relative(o, a));
            let s = this._mappings.toArray().length > 0 ? new r : this._sources
              , c = new r;
            this._mappings.unsortedForEach(function(t) {
                if (t.source === a && t.originalLine != null) {
                    let r = e.originalPositionFor({
                        line: t.originalLine,
                        column: t.originalColumn
                    });
                    r.source != null && (t.source = r.source,
                    i != null && (t.source = n.join(i, t.source)),
                    o != null && (t.source = n.relative(o, t.source)),
                    t.originalLine = r.line,
                    t.originalColumn = r.column,
                    r.name != null && (t.name = r.name))
                }
                let r = t.source;
                r != null && !s.has(r) && s.add(r);
                let l = t.name;
            ...
            e.sources.forEach(function(t) {
                let r = e.sourceContentFor(t);
                r != null && (i != null && (t = n.join(i, t)),
                o != null && (t = n.relative(o, t)),
        ...
        _serializeMappings() {
            let e = 0, r = 1, i = 0, a = 0, o = 0, s = 0, c = ``, l, u, d, f, p = this._mappings.toArray();
            for (let m = 0, h = p.length; m < h; m++) {
                if (u = p[m],
                l = ``,
                u.generatedLine !== r)
                    ...
                    if (!n.compareByGeneratedPositionsInflated(u, p[m - 1]))
                        continue;
                    l += `,`
                }
                l += t.encode(u.generatedColumn - e),
                e = u.generatedColumn,
                u.source != null && (f = this._sources.indexOf(u.source),
                l += t.encode(f - s),
                s = f,
                l += t.encode(u.originalLine - 1 - a),
                a = u.originalLine - 1,
                l += t.encode(u.originalColumn - i),
                i = u.originalColumn,
                u.name != null && (d = this._names.indexOf(u.name),
                l += t.encode(d - o),
                o = d)),
                c += l
            }
        ...
        _generateSourcesContent(e, t) {
            return e.map(function(e) {
                if (!this._sourcesContents)
                    return null;
                t != null && (e = n.relative(t, e));
                let r = n.toSetString(e);
  ...
  , Ae = i((e => {
    ...
    function t(n, r, i, a, o, s) {
        let c = Math.floor((r - n) / 2) + n
          , l = o(i, a[c], !0);
        return l === 0 ? c : l > 0 ? r - c > 1 ? t(c, r, i, a, o, s) : s === e.LEAST_UPPER_BOUND ? r < a.length ? r : -1 : c : c - n > 1 ? t(n, c, i, a, o, s) : s == e.LEAST_UPPER_BOUND ? c : n < 0 ? -1 : n
    }
    e.search = function(n, r, i, a) {
        if (r.length === 0)
            return -1;
        let o = t(-1, r.length, n, r, i, a || e.GREATEST_LOWER_BOUND);
        if (o < 0)
            return -1;
        for (; o - 1 >= 0 && i(r[o], r[o - 1], !0) === 0; )
            --o;
        return o
    }
}
  ...
  , je = i(( (e, t) => {
    ...
    t.exports = function() {
        if (typeof n == `string`)
            return fetch(n).then(e => e.arrayBuffer());
        if (n instanceof ArrayBuffer)
            return Promise.resolve(n);
        throw Error(`You must provide the string URL or ArrayBuffer contents of lib/mappings.wasm by calling SourceMapConsumer.initialize({ 'lib/mappings.wasm': ... }) before using SourceMapConsumer`)
    }
    ,
    t.exports.initialize = e => {
        n = e
    }
}
))
  , Me = i(( (e, t) => {
    ...
    t.exports = function() {
        if (i)
            return i;
        let e = [];
        return i = n().then(t => WebAssembly.instantiate(t, {
            env: {
                mapping_callback(t, n, i, a, o, s, c, l, u, d) {
                    let f = new r;
                    f.generatedLine = t + 1,
                    f.generatedColumn = n,
                    i && (f.lastGeneratedColumn = a - 1),
                    o && (f.source = s,
                    f.originalLine = c + 1,
                    f.originalColumn = l,
                    u && (f.name = d)),
  ...
  , Ne = i((e => {
    ...
    var i = je()
      , a = Me()
      , o = Symbol(`smcInternal`)
      , s = class e {
        constructor(e, t) {
            return e == o ? Promise.resolve(this) : u(e, t)
        }
        static initialize(e) {
            i.initialize(e[`lib/mappings.wasm`])
        }
        static fromSourceMap(e, t) {
            return d(e, t)
        }
        static async with(t, n, r) {
            let i = await new e(t,n);
            try {
                return await r(i)
            } finally {
                i.destroy()
    ...
    var c = class e extends s {
        constructor(e, n) {
            return super(o).then(i => {
                let o = e;
                typeof e == `string` && (o = t.parseSourceMapInput(e));
                let s = t.getArg(o, `version`)
                  , c = t.getArg(o, `sources`).map(String)
                  , l = t.getArg(o, `names`, [])
                  , u = t.getArg(o, `sourceRoot`, null)
                  , d = t.getArg(o, `sourcesContent`, null)
                  , f = t.getArg(o, `mappings`)
                  , p = t.getArg(o, `file`, null)
                  , m = t.getArg(o, `x_google_ignoreList`, null);
                if (s != i._version)
                    throw Error(`Unsupported version: ` + s);
                return i._sourceLookupCache = new Map,
                i._names = r.fromArray(l.map(String), !0),
                i._sources = r.fromArray(c, !0),
                i._absoluteSources = r.fromArray(i._sources.toArray().map(function(e) {
                    return t.computeSourceURL(u, e, n)
                }), !0),
                i.sourceRoot = u,
                i.sourcesContent = d,
                i._mappings = f,
                i._sourceMapURL = n,
                i.file = p,
                i.x_google_ignoreList = m,
                i._computedColumnSpans = !1,
                i._mappingsPtr = 0,
                i._wasm = null,
                a().then(e => (i._wasm = e,
                i))
        ...
        _findSourceIndex(e) {
            let n = this._sourceLookupCache.get(e);
            if (typeof n == `number`)
                return n;
            let r = t.computeSourceURL(null, e, this._sourceMapURL);
            if (this._absoluteSources.has(r)) {
                let t = this._absoluteSources.indexOf(r);
                return this._sourceLookupCache.set(e, t),
                t
            }
            let i = t.computeSourceURL(this.sourceRoot, e, this._sourceMapURL);
            if (this._absoluteSources.has(i)) {
                let t = this._absoluteSources.indexOf(i);
                return this._sourceLookupCache.set(e, t),
                t
            }
            return -1
        }
        static fromSourceMap(t, n) {
        ...
        _parseMappings() {
            let e = this._mappings
              , t = e.length
              , n = this._wasm.exports.allocate_mappings(t) >>> 0
              , r = new Uint8Array(this._wasm.exports.memory.buffer,n,t);
            for (let n = 0; n < t; n++)
                r[n] = e.charCodeAt(n);
            let i = this._wasm.exports.parse_mappings(n);
            if (!i) {
                let e = this._wasm.exports.get_last_error()
                  , t = `Error parsing mappings (code ${e}): `;
                switch (e) {
                case 1:
        ...
        eachMapping(e, t, n) {
            let r = t || null
              , i = n || s.GENERATED_ORDER;
            this._wasm.withMappingCallback(t => {
                t.source !== null && (t.source = this._absoluteSources.at(t.source),
                t.name !== null && (t.name = this._names.at(t.name))),
                this._computedColumnSpans && t.lastGeneratedColumn === null && (t.lastGeneratedColumn = 1 / 0),
                e.call(r, t)
            }
            , () => {
                switch (i) {
        ...
        allGeneratedPositionsFor(e) {
            let n = t.getArg(e, `source`)
              , r = t.getArg(e, `line`)
              , i = e.column || 0;
            if (n = this._findSourceIndex(n),
            n < 0)
                return [];
            if (r < 1)
                throw Error(`Line numbers must be >= 1`);
            if (i < 0)
                throw Error(`Column numbers must be >= 0`);
            let a = [];
            return this._wasm.withMappingCallback(e => {
                let t = e.lastGeneratedColumn;
                this._computedColumnSpans && t === null && (t = 1 / 0),
                a.push({
                    line: e.generatedLine,
                    column: e.generatedColumn,
                    lastColumn: t
            ...
            , () => {
                this._wasm.exports.all_generated_locations_for(this._getMappingsPtr(), n, r - 1, `column`in e, i)
            }
            ),
            a
        }
        ...
        originalPositionFor(e) {
            ...
            if (n.generatedColumn < 0)
                throw Error(`Column numbers must be >= 0`);
            let r = t.getArg(e, `bias`, s.GREATEST_LOWER_BOUND);
            r ??= s.GREATEST_LOWER_BOUND;
            let i;
            if (this._wasm.withMappingCallback(e => i = e, () => {
                this._wasm.exports.original_location_for(this._getMappingsPtr(), n.generatedLine - 1, n.generatedColumn, r)
            }
            ),
            i && i.generatedLine === n.generatedLine) {
                let e = t.getArg(i, `source`, null);
                e !== null && (e = this._absoluteSources.at(e));
                let n = t.getArg(i, `name`, null);
                return n !== null && (n = this._names.at(n)),
                {
                    source: e,
                    line: t.getArg(i, `originalLine`, null),
                    column: t.getArg(i, `originalColumn`, null),
                    name: n
                }
            }
            return {
        ...
        generatedPositionFor(e) {
            ...
            if (r.originalLine < 1)
                throw Error(`Line numbers must be >= 1`);
            if (r.originalColumn < 0)
                throw Error(`Column numbers must be >= 0`);
            let i = t.getArg(e, `bias`, s.GREATEST_LOWER_BOUND);
            i ??= s.GREATEST_LOWER_BOUND;
            let a;
            if (this._wasm.withMappingCallback(e => a = e, () => {
                this._wasm.exports.generated_location_for(this._getMappingsPtr(), r.source, r.originalLine - 1, r.originalColumn, i)
            }
            ),
            a && a.source === r.source) {
                let e = a.lastGeneratedColumn;
                return this._computedColumnSpans && e === null && (e = 1 / 0),
                {
                    line: t.getArg(a, `generatedLine`, null),
                    column: t.getArg(a, `generatedColumn`, null),
                    lastColumn: e
                }
            }
            return {
    ...
    e.BasicSourceMapConsumer = c;
    var l = class extends s {
        constructor(e, n) {
            return super(o).then(r => {
                let i = e;
                typeof e == `string` && (i = t.parseSourceMapInput(e));
                let a = t.getArg(i, `version`)
                  , o = t.getArg(i, `sections`);
                if (a != r._version)
                ...
                return Promise.all(o.map(e => {
                    ...
                    let r = t.getArg(e, `offset`)
                      , i = t.getArg(r, `line`)
                      , a = t.getArg(r, `column`);
                    if (i < c.line || i === c.line && a < c.column)
                        throw Error(`Section offsets must be ordered and non-overlapping.`);
                    return c = r,
                    new s(t.getArg(e, `map`),n).then(e => ({
                        generatedOffset: {
                            generatedLine: i + 1,
                            generatedColumn: a + 1
                        },
        ...
        originalPositionFor(e) {
            let r = {
              ...
              , i = n.search(r, this._sections, function(e, t) {
        ...
        sourceContentFor(e, t) {
            for (let t = 0; t < this._sections.length; t++) {
                let n = this._sections[t].consumer.sourceContentFor(e, !0);
                if (n)
                    return n
            }
            if (t)
        ...
        _findSectionIndex(e) {
            for (let t = 0; t < this._sections.length; t++) {
                let {consumer: n} = this._sections[t];
                if (n._findSourceIndex(e) !== -1)
                    return t
            }
            return -1
        }
        generatedPositionFor(e) {
            let n = this._findSectionIndex(t.getArg(e, `source`))
              , r = n >= 0 ? this._sections[n] : null
              , i = n >= 0 && n + 1 < this._sections.length ? this._sections[n + 1] : null
              , a = r && r.consumer.generatedPositionFor(e);
            if (a && a.line !== null) {
                let e = r.generatedOffset.generatedLine - 1
                  , t = r.generatedOffset.generatedColumn - 1;
                return a.line === 1 && (a.column += t,
                typeof a.lastColumn == `number` && (a.lastColumn += t)),
                a.lastColumn === 1 / 0 && i && a.line === i.generatedOffset.generatedLine && (a.lastColumn = i.generatedOffset.generatedColumn - 2),
                a.line += e,
                a
            }
            return {
        ...
        allGeneratedPositionsFor(e) {
            let n = this._findSectionIndex(t.getArg(e, `source`))
              , r = n >= 0 ? this._sections[n] : null
              , i = n >= 0 && n + 1 < this._sections.length ? this._sections[n + 1] : null;
            return r ? r.consumer.allGeneratedPositionsFor(e).map(e => {
                let t = r.generatedOffset.generatedLine - 1
                  , n = r.generatedOffset.generatedColumn - 1;
                return e.line === 1 && (e.column += n,
                typeof e.lastColumn == `number` && (e.lastColumn += n)),
                e.lastColumn === 1 / 0 && i && e.line === i.generatedOffset.generatedLine && (e.lastColumn = i.generatedOffset.generatedColumn - 2),
                e.line += t,
                e
            }
            ) : []
        ...
        eachMapping(e, t, n) {
            this._sections.forEach( (r, i) => {
                let a = i + 1 < this._sections.length ? this._sections[i + 1] : null
                  , {generatedOffset: o} = r
                  , s = o.generatedLine - 1
                  , c = o.generatedColumn - 1;
                r.consumer.eachMapping(function(t) {
                    t.generatedLine === 1 && (t.generatedColumn += c,
                    typeof t.lastGeneratedColumn == `number` && (t.lastGeneratedColumn += c)),
    ...
    ;
    e.IndexedSourceMapConsumer = l;
    function u(e, n) {
        let r = e;
        typeof e == `string` && (r = t.parseSourceMapInput(e));
        let i = r.sections == null ? new c(r,n) : new l(r,n);
  ...
  , Pe = i((e => {
    var t = ke().SourceMapGenerator
      , n = Ee()
      , r = /(\r?\n)/
      , i = 10
      , a = `$$$isSourceNode$$$`;
    e.SourceNode = class e {
        ...
        static fromStringWithSourceMap(t, i, a) {
            let o = new e, s = t.split(r), c = 0, l = function() {
                return e() + (e() || ``);
                function e() {
                    return c < s.length ? s[c++] : void 0
                }
            }, u = 1, d = 0, f = null, p;
            return i.eachMapping(function(e) {
                if (f !== null)
                    if (u < e.generatedLine)
                        ...
                        p = s[c] || ``;
                        let t = p.substr(0, e.generatedColumn - d);
                        s[c] = p.substr(e.generatedColumn - d),
                        d = e.generatedColumn,
                        m(f, t),
                        f = e;
                        return
                ...
                for (; u < e.generatedLine; )
                    o.add(l()),
                    u++;
                d < e.generatedColumn && (p = s[c] || ``,
                o.add(p.substr(0, e.generatedColumn)),
                s[c] = p.substr(e.generatedColumn),
                d = e.generatedColumn),
                f = e
            }, this),
            c < s.length && (f && m(f, l()),
            o.add(s.splice(c).join(``))),
            i.sources.forEach(function(e) {
                let t = i.sourceContentFor(e);
                t != null && (a != null && (e = n.join(a, e)),
            ...
            function m(t, r) {
                if (t === null || t.source === void 0)
                    ...
                    let i = a ? n.join(a, t.source) : t.source;
                    o.add(new e(t.originalLine,t.originalColumn,i,r,t.name))
                }
            }
        }
        add(e) {
            if (Array.isArray(e))
                ...
                throw TypeError(`Expected a SourceNode, string, or an array of SourceNodes and strings. Got ` + e);
            return this
        }
        prepend(e) {
            if (Array.isArray(e))
        ...
        join(e) {
            let t, n, r = this.children.length;
            if (r > 0) {
                for (t = [],
                n = 0; n < r - 1; n++)
        ...
        replaceRight(e, t) {
            ...
            return n[a] ? n.replaceRight(e, t) : typeof n == `string` ? this.children[this.children.length - 1] = n.replace(e, t) : this.children.push(``.replace(e, t)),
            this
        }
        setSourceContent(e, t) {
        ...
        walkSourceContents(e) {
            ...
            for (let r = 0, i = t.length; r < i; r++)
                e(n.fromSetString(t[r]), this.sourceContents[t[r]])
        }
        toString() {
            let e = ``;
        ...
        toStringWithSourceMap(e) {
            ...
            return this.walk(function(e, t) {
                n.code += e,
                t.source !== null && t.line !== null && t.column !== null ? ((o !== t.source || s !== t.line || c !== t.column || l !== t.name) && r.addMapping({
                    source: t.source,
                    original: {
                        line: t.line,
                        column: t.column
  ...
  , Fe = i((e => {
    e.SourceMapGenerator = ke().SourceMapGenerator,
    e.SourceMapConsumer = Ne().SourceMapConsumer,
    e.SourceNode = Pe().SourceNode
}
))();
function Ie(e, t, n) {
    let r = e[t];
    ...
    let i = r.trim()
      , a = /^<\/[A-Za-z][A-Za-z0-9\-_.]*\s*>$/.test(i)
      , o = /<\/[A-Za-z][A-Za-z0-9\-_.]*\s*>$/.test(i)
      , s = !1;
    if (n != null) {
        let e = r.substring(0, n);
        s = /<\/[A-Za-z][A-Za-z0-9\-_.]*\s*>$/.test(e)
    }
    if (a || o || s) {
        if (n != null) {
            let e = r.substring(n)
              , i = e.match(/<([A-Za-z][A-Za-z0-9\-_.]*)/);
            if (i && e[i.index + 1] !== `/`)
                return {
                    lineIndex: t,
                    column: n + i.index + 1
        ...
        for (let n = t + 1; n < e.length && n < t + 50; n++) {
            let t = e[n]
              , r = t.match(/<([A-Za-z][A-Za-z0-9\-_.]*)/);
            if (r && t[r.index + 1] !== `/`)
                return {
                    lineIndex: n,
                    column: r.index + 1
...
function Re(e, t, n, r) {
    ...
    for (let t = n; t < e.length; t++) {
        let s = t === n ? r : 0, c = e[t].substring(s), l = [], u;
        for (a.lastIndex = 0; (u = a.exec(c)) !== null; ) {
            let e = Le([c], 0, u.index + u[0].length);
            e && !e.isSelfClosing && l.push({
                type: `open`,
                index: u.index,
                length: u[0].length
            })
        }
        for (o.lastIndex = 0; (u = o.exec(c)) !== null; )
            l.push({
                type: `close`,
                index: u.index,
                length: u[0].length
        ...
        for (let e of l)
            if (e.type === `open`)
                i++;
            else if (e.type === `close` && (i--,
            i === 0))
                return {
                    lineIndex: t,
                    columnEnd: s + e.index + e.length
                }
    }
}
function ze(e, t, n) {
    let r;
    for (let i = t; i >= 0; i--) {
        let a = e[i], o = /<([A-Za-z][A-Za-z0-9\-_.]*)/g, s;
        for (; (s = o.exec(a)) !== null; ) {
            let o = s.index
              , c = s[1];
            if (a[o + 1] === `/` || !(i < t || i === t && o <= (n ?? a.length)))
                continue;
            let l = o + s[0].length
              , u = Le(e, i, l);
            if (!u)
            ...
            let d = i
              , f = u.columnEnd;
            if (!u.isSelfClosing) {
                let t = Re(e, c, i, u.columnEnd);
                if (!t)
                    continue;
                d = t.lineIndex,
                f = t.columnEnd
            }
            (i < t || i === t && o <= (n ?? a.length)) && (d > t || d === t && f >= (n ?? 0)) && (!r || d - i < r.closeLineIndex - r.lineIndex || d - i === r.closeLineIndex - r.lineIndex && f - o < r.closeColumnEnd - r.columnStart) && (r = {
                tagName: c,
                lineIndex: i,
                columnStart: o,
                columnEnd: u.columnEnd,
                isSelfClosing: u.isSelfClosing,
                closeLineIndex: d,
                closeColumnEnd: f
            })
        }
...
function Ve(e, t, n, r, i) {
    if (t === r)
        return e[t].substring(n, i);
    let a = e[t].substring(n);
    for (let n = t + 1; n < r; n++)
        a += `
` + e[n];
    return a += `
...
function He(e, t, n=10) {
    let r = e.split(`
`)
      , i = Math.max(0, t - n - 1)
      , a = Math.min(r.length - 1, t + n - 1)
      , o = [];
    for (let e = i; e <= a; e++) {
        let n = e + 1
          , i = `${n === t ? `>>>` : `   `} ${n.toString().padStart(4, ` `)} | ${r[e] || ``}`;
        o.push(i)
    }
    return o.join(`
`)
...
async function Ue(e) {
    try {
        let t = await fetch(e);
        if (!t.ok)
            throw Error(`Failed to load source map: ${t.status}`);
        return await t.json()
    } catch (t) {
        let n = t instanceof Error ? t.message : String(t);
        console.warn(`Error loading source map from`, e, n)
    }
}
var We = !1
  , Ge = new Map
...
setInterval( () => {
    let e = Date.now();
    for (let[t,n] of Ge.entries())
        e - n.timestamp > Ke && Ge.delete(t)
}
, 6e4);
async function Je() {
    if (!We)
        try {
            await Fe.SourceMapConsumer.initialize({
                "lib/mappings.wasm": `https://unpkg.com/source-map@0.7.6/lib/mappings.wasm`
            }),
            We = !0
        } catch (e) {
            console.warn(`Failed to initialize SourceMapConsumer:`, e);
            try {
                await Fe.SourceMapConsumer.initialize({}),
                We = !0
            } catch (e) {
                throw console.error(`SourceMapConsumer initialization failed completely:`, e),
                e
            }
        }
}
function Ye(e) {
    if (!e || !e.stack)
        return `no-stack-${e?.message || `unknown`}`;
    let t = e.stack.split(`
`).slice(0, 6).map(e => e.replace(/\?t=\d+/g, ``).replace(/\?v=[\w\d]+/g, ``).replace(/\d{13,}/g, `TIMESTAMP`));
    return `${e.name || `Error`}-${e.message}-${t.join(`|`)}`
}
var Xe = `preview-inject/`;
async function Ze(e, t=10, n) {
    if (!e || !e.stack)
        return {
    ...
    if (Ge.has(r)) {
        let e = Ge.get(r);
        return console.log(`Using cached error mapping for:`, r),
        e
    }
    if (Ge.size >= qe)
        return null;
...
`)
      ...
      , l = 0;
    for (let e of i) {
        let r = e.match(/at\s+(.+?)\s+\((.+?):(\d+):(\d+)\)|at\s+(.+?):(\d+):(\d+)|([^@]*)@(.+?):(\d+):(\d+)/);
        if (!r) {
            a.push(e);
            continue
        }
        ...
        u = r[2],
        d = parseInt(r[3]),
        f = parseInt(r[4])) : r[5] ? (i = `<anonymous>`,
        u = r[5],
        d = parseInt(r[6]),
        f = parseInt(r[7])) : (i = r[8],
        u = r[9],
        d = parseInt(r[10]),
        f = parseInt(r[11]));
        try {
            let r = `${u}.map`
              , p = s.get(r);
            p || (p = await new Fe.SourceMapConsumer(await Ue(r)),
            s.set(r, p));
            let m = p.originalPositionFor({
                line: d,
                column: f
            });
            if (m.source) {
                if (m.source.includes(Xe))
                    continue;
                let e = m.source.split(`/`).filter(e => e !== `..`).join(`/`)
                  , r = `    at ${m.name || i} (${e}:${m.line}:${m.column})`;
                if (a.push(r),
                m.line && m.column && l < t) {
                    l++;
                    try {
                        let t = await Qe(p, m.source, c);
                        if (t) {
                            let r = e.includes(`node_modules`), i = /\.(tsx|jsx)$/.test(e), a;
                            if (!r && i) {
                                let e = $e(t, m.line, m.column, n);
                                e && (a = {
                                    tagName: e.tagName,
                                    code: e.code,
                                    context: e.context,
                        ...
                        console.warn(`Failed to extract source context:`, e)
                    }
                }
            } else
                a.push(e)
        } catch (t) {
            console.warn(`Failed to map stack line:`, e, t),
            a.push(e)
        }
    }
...
`)
    ...
    if (r && o) {
        let e = r.toLowerCase();
        if (e !== o.tagName.toLowerCase()) {
            let t = Be(i, a, e);
            t && (o = t)
        }
    } else if (!o) {
        let e = Ie(i, a, n);
        o = ze(i, e.lineIndex, e.column)
    }
    if (!o)
        return;
    let {tagName: s, lineIndex: c, columnStart: l, closeLineIndex: u, closeColumnEnd: d, isSelfClosing: f} = o;
    return {
        tagName: s,
        code: Ve(i, c, l, u, d),
        context: i.slice(c, u + 1).join(`
`),
        startLine: c + 1,
        endLine: u + 1,
        isSelfClosing: f
...
var et = class {
    constructor() {
        ...
        e.length > 0 && e.forEach(e => {
            e.type === `console.error` ? this.handleConsoleError(e.args) : e.type === `runtime` && this.handleError(e.args)
        }
        ),
        this.client = new ee(window.parent),
    ...
    async handleError(e) {
        let t = e.target;
        if (!(t && t instanceof HTMLElement && t.tagName && [`IMG`, `SCRIPT`, `LINK`, `VIDEO`, `AUDIO`, `SOURCE`, `IFRAME`].includes(t.tagName)) && e.error && e.error.stack)
            try {
                let t = await Ze(e.error);
                this.sendError(t)
            } catch (e) {
                console.warn(`Failed to map error stack:`, e)
            }
    }
    async handlePromiseRejection(e) {
        ...
        if (t.stack)
            try {
                ...
                console.warn(`Failed to map promise rejection stack:`, e)
            }
    }
    interceptConsoleError() {
        console.error = (...e) => {
            this.originalConsoleError.apply(console, e);
            let t = e.find(e => e instanceof Error);
            if (t && t.stack)
                this.handleConsoleError(t);
            else if (e.length > 0) {
                let t = e.map(e => typeof e == `object` ? JSON.stringify(e) : String(e)).join(` `)
                  , n = Error(t);
                this.handleConsoleError(n)
            }
        }
    }
    async handleConsoleError(e) {
        try {
            let t = await Ze(e);
            this.sendError(t)
        } catch (e) {
            console.warn(`Failed to map console error stack:`, e)
        }
    }
    reportError(e) {
        this.handleReactError(e)
    }
    async handleReactError(e) {
        try {
            let t = await Ze(e);
            this.sendError(t)
        } catch (e) {
            console.warn(`Failed to map React error stack:`, e)
        }
    }
    async sendError(e) {
        if (!e) {
        ...
        if (e.sourceContext.length !== 0)
            try {
                await this.client.post(`runtime-error`, e)
            } catch (e) {
...
function tt() {
    let e = new et;
    return window.runtimeErrorCollector = e,
    e
}
var nt = class {
    constructor() {
        this._client = new ee(window.parent),
    ...
    _domContentLoadedListener() {
        ...
        ;
        document.readyState === `loading` ? document.addEventListener(`DOMContentLoaded`, e) : (console.log(`DOMContentLoaded`),
        this._client.post(`DOMContentLoaded`))
    }
}
;
...
var it = e => {
    let t = `/preview/9deabda6-5e99-4d9b-9ff8-10c23eeccb75/10010999`;
    return e.startsWith(t) ? e.replaceAll(t, ``) || `/` : e || `/`
}
;
async function at() {
    await await t( () => Promise.resolve().then( () => Nr).then(e => e.navigatePromise), void 0).catch(e => (console.error(e),
    Promise.resolve( () => {}
    ))),
    window.REACT_APP_ROUTER = {
        push: (e, t) => {
            window.REACT_APP_NAVIGATE(e, t)
        }
        ,
        replace: (e, t, n) => {
            window.REACT_APP_NAVIGATE(e, {
                replace: !0,
                ...n
            })
        }
...
var ot = new Promise(e => {
    at().then( () => {
        e(window.REACT_APP_ROUTER)
    }
    )
}
)
  , st = () => window.REACT_APP_ROUTER
  , ct = new ee(window.parent)
  , lt = async (e, t) => {
    await ct.post(`routeWillChange`, {
        next: it(e)
    }, t)
}
;
...
function dt() {
    let e = window.open;
    return window.open = function(t, n, r) {
        return t && typeof t == `string` && t.startsWith(`#`) ? (ut(t),
        null) : (e(t, `_blank`, r),
        null)
    }
    ,
...
function ft() {
    let e = async e => {
        ...
        if (n && ![`#`, `javascript:void(0)`, ``].includes(n) && !n.startsWith(`#`)) {
            if (e.preventDefault(),
            n.startsWith(`/`)) {
                let e = st();
                await lt(n, {
...
var pt = e => e.startsWith(`http://`) || e.startsWith(`https://`);
function mt(e) {
    return !e || typeof e != `string` ? !1 : e.indexOf(`accounts.google.com`) !== -1 || e.indexOf(`googleapis.com/oauth`) !== -1 || e.indexOf(`/auth/`) !== -1 && e.indexOf(`provider=google`) !== -1
}
function ht() {
    let e = () => {
        let e = st()
          , t = e.push;
        e.push = async function(e, n, r) {
            return pt(e) ? (window.open(e, `_blank`),
            Promise.resolve(!1)) : (await lt(e, {
                timeout: 500
            }),
            t.call(this, e, n, r))
        }
        ;
        let n = e.replace;
        e.replace = async function(e, t, r) {
            return pt(e) ? (window.open(e, `_blank`),
            Promise.resolve(!1)) : (await lt(e, {
                timeout: 500
            }),
...
function gt() {
    if (!(`navigation`in window))
        ...
        ;
    let e = e => {
        mt(e.destination.url) && ct.post(`google-auth-blocked`, {
    ...
    () => {
        window.navigation.removeEventListener(`navigate`, e)
    }
}
async function _t() {
    await ot;
...
async function vt() {
    let e = await t( () => import(`./config-BUHTk5A2.js`).then(e => e.t).then(e => e.default), []).catch(e => [])
      , n = []
      , r = 0;
    function i(e, t) {
        let {path: a=``, children: o, index: s} = e;
        r++;
        let c = s === !0 || a === ``
          , l = a && a[0] === `/`
          , u = c ? t.path : `${t.path}/${a}`
          ...
          , f = {
            id: r,
            parentId: t.id,
            path: `/` + d.split(`/`).filter(Boolean).join(`/`)
        };
        /\*/.test(f.path) || n.push(f),
        o && o.forEach(e => i(e, f))
    }
    e.forEach(e => i(e, {
        id: 0,
    ...
    let a = new Set;
    return n = n.filter(e => a.has(e.path) ? !1 : (a.add(e.path),
    !0)),
    n
}
async function yt() {
    let e = new ee(window.parent)
      , t = await vt();
    window.REACT_APP_ROUTES = t,
    e.post(`routes`, {
        routes: t
    }),
    e.on(`getRouteInfo`, async e => t),
    await ot,
    ...
    function r() {
        let t = new MutationObserver(t => {
            t.forEach(t => {
                (t.type === `childList` || t.type === `characterData`) && e.post(`titleChanged`, {
    ...
    let o = window.history.pushState
      , s = window.history.replaceState
      , c = window.history.go
      , l = window.history.back
      , u = window.history.forward;
    return window.history.pushState = function(e, t, r) {
...
var wt = class {
  ...
  , At = (e, t) => {
    try {
        Et.set(e, t);
        let n = wt.getFiberFromDOMNode(e);
        n && Tt.set(n, t)
    } catch {}
}
  , jt = (e, t) => {
    if (!e)
        return e => {
            e instanceof HTMLElement && At(e, t)
        }
        ;
    ...
    let e = St.createElement
      ...
      , r = (e, t, n) => {
        ...
        try {
            ...
            console.warn(`[Debug Source] Failed to override ${String(t)}:`, e)
        }
    }
      , i = () => {
        let e = Error();
      ...
      , a = e => typeof e == `string`;
    St.default.createElement = function(t, n, ...r) {
...
function Nt(e) {
    ...
    let i = wt.getFiberFromDOMNode(t);
    if (i) {
        let e = Tt.get(i);
        if (e)
            return {
...
function Pt() {
    let e = new WeakMap
      , t = new ee(window.parent);
    return t.on(`get-element-source`, async ({selector: t}) => {
        let n = Nt(t);
        if (!n)
            return null;
        let {element: r, tagName: i, debugError: a} = n;
        if (e.has(r))
            return e.get(r);
        let o = await Ze(a, 10, i);
        if (!o)
            return null;
        let s = {
            ...o.sourceContext.filter(e => !e.file.includes(`node_modules`))[0],
            domInfo: {
                tagName: r.tagName,
                textContent: r.textContent.slice(0, 300)
            }
        };
        return e.set(r, s),
        s
...
console.log(`Is preview build:`, !0);
async function Ft() {
    xe(),
    tt(),
    _t(),
...
Ft();
var It = `phc_V7JMHB0fVJGRu8UHyrsj6pSL1BS76P5zD8qCi7lrTTV`
  , O = {
    colors: {
        text: `#5D5D5D`,
        white: `#FFFFFF`,
  ...
  , Lt = {
    close: `data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%232D303D%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cline%20x1%3D%2218%22%20y1%3D%226%22%20x2%3D%226%22%20y2%3D%2218%22%2F%3E%3Cline%20x1%3D%226%22%20y1%3D%226%22%20x2%3D%2218%22%20y2%3D%2218%22%2F%3E%3C%2Fsvg%3E`,
    generate: `data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20width%3D%2216%22%20height%3D%2216%22%20viewBox%3D%220%200%2016%2016%22%3E%3Cpath%20fill-rule%3D%22evenodd%22%20d%3D%22M4.87%204.94c.227-.71%201.21-.723%201.456-.02l1.177%203.378%203.101%201.013c.708.231.714%201.216.01%201.455l-3.183%201.082-1.105%203.17c-.245.704-1.23.69-1.455-.02l-.989-3.107-3.367-1.203c-.702-.25-.68-1.234.04-1.455l3.282-1.016%201.043-3.277Z%22%20fill%3D%22%23FFF%22%2F%3E%3Cpath%20fill-rule%3D%22evenodd%22%20d%3D%22M12.238%201.3c.167-.667%201.1-.667%201.266%200l.388%201.551%201.55.388c.666.166.667%201.1%200%201.266l-1.55.388-.388%201.55c-.167.666-1.1.667-1.266%200l-.388-1.55-1.55-.388c-.667-.166-.667-1.1%200-1.266l1.55-.388.388-1.551Z%22%20fill%3D%22%23FFF%22%2F%3E%3C%2Fsvg%3E`
}
  , Rt = {
  ...
  , Bt = () => navigator.language?.toLowerCase().startsWith(`zh`) ?? !1
  , Vt = () => Bt() ? zt.zh : zt.en
  , Ht = () => window.innerWidth > 768 && !(`ontouchstart`in window)
  , Ut = () => {
    let e = window.location.hostname;
    return [`readdy.ai`, `dev.readdy.ai`, `localhost`].some(t => e === t || e.endsWith(`.${t}`))
}
;
function Wt() {
    if (window.posthog)
    ...
    e.onload = () => {
        window.posthog?.init(It, {
            ...
            rageclick: !1,
            loaded: function(e) {
                e.sessionRecording && e.sessionRecording.stopRecording()
            }
        })
    }
    ,
...
function Jt() {
    ...
    async function e(e) {
        try {
            return !(await (await fetch(`https://readdy.ai/api/public/user/is_free?projectId=${e}`, {
                method: `GET`,
                headers: {
    ...
    function t() {
        ...
        e.type = `image/png`,
        e.rel = `icon`,
        e.href = Rt.readdyLogo,
        document.head.appendChild(e);
        let t = document.createElement(`link`);
        t.rel = `stylesheet`,
        t.href = Rt.fontStylesheet,
        document.head.appendChild(t)
    }
    function n(e) {
        Gt(e),
        window.open(Rt.readdyLink, `_blank`)
    }
    function r() {
        ...
        e.addEventListener(`click`, e => {
            e.stopPropagation(),
            Gt(`watermark_close_button_click`),
    ...
    function i(e) {
        ...
        t.id = `generate-button`,
        k(t, {
            padding: e ? `8px 16px` : `10px 20px`,
            background: O.button.gradient,
            borderRadius: `999px`,
            border: `none`,
            gap: `6px`,
            cursor: `pointer`,
        ...
        return i.textContent = Vt().button,
        k(i, {
            color: O.colors.white,
            fontFamily: O.font.family,
            fontSize: O.font.size.button,
            fontWeight: O.font.weight,
            lineHeight: O.font.lineHeight
        }),
        t.append(r, i),
        t.addEventListener(`click`, e => {
            e.stopPropagation(),
            n(`watermark_create_button_click`)
        }
        ),
        t
    }
    ...
    function c(e) {
        let {prefix: t, suffix: n} = Vt()
          , [r,o] = n.startsWith(`.`) ? [`.`, n.slice(1).trim()] : [``, n]
          , c = document.createElement(`div`);
        qt(c),
        c.style.marginBottom = `4px`,
        c.append(s(t), a(), ...r ? [s(r)] : []),
        e.append(c, s(o, {
            textAlign: `center`,
            marginBottom: `12px`
        }), i(!1))
    ...
    function l() {
        ...
        k(t, {
            ...
            width: e ? `fit-content` : `calc(100% - 32px)`,
            maxWidth: e ? `none` : `100%`,
            backgroundColor: O.colors.white,
            borderStyle: `solid`,
            borderWidth: `1px`,
            borderRadius: e ? `999px` : `36px`,
            borderColor: O.colors.border,
            padding: e ? `12px 20px` : `16px`,
            boxShadow: O.shadow,
            cursor: `pointer`
        }),
        qt(t, e ? `row` : `column`),
        ...
        e ? o(t) : c(t),
        t.addEventListener(`click`, e => {
            e.target.closest(`#generate-button, #close-button`) || n(`watermark_create_button_click`)
        }
        ),
        t
    }
    function u(e) {
        let n = document.getElementById(`watermark`);
        !n && !e ? (document.body.appendChild(l()),
        t(),
        Wt()) : e && n && n.remove()
    }
    e(`9deabda6-5e99-4d9b-9ff8-10c23eeccb75`).then(u)
}
Jt();
var A = e => typeof e == `string`
  ...
  , Qt = /###/g
  , $t = e => e && e.indexOf(`###`) > -1 ? e.replace(Qt, `.`) : e
  , en = e => !e || A(e)
  , tn = (e, t, n) => {
    let r = A(t) ? t.split(`.`) : t
      , i = 0;
  ...
  , rn = (e, t, n, r) => {
    let {obj: i, k: a} = tn(e, t, Object);
    i[a] = i[a] || [],
    i[a].push(n)
}
  , an = (e, t) => {
    let {obj: n, k: r} = tn(e, t);
    if (n && Object.prototype.hasOwnProperty.call(n, r))
        return n[r]
}
  , on = (e, t, n) => {
    let r = an(e, n);
    return r === void 0 ? an(t, n) : r
}
  , sn = (e, t, n) => {
    for (let r in t)
        r !== `__proto__` && r !== `constructor` && (r in e ? A(e[r]) || e[r]instanceof String || A(t[r]) || t[r]instanceof String ? n && (e[r] = t[r]) : sn(e[r], t[r], n) : e[r] = t[r]);
    return e
}
  , cn = e => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, `\\$&`)
  , ln = {
  ...
  , mn = (e, t, n) => {
    t ||= ``,
    n ||= ``;
    let r = fn.filter(e => t.indexOf(e) < 0 && n.indexOf(e) < 0);
    if (r.length === 0)
        return !0;
    let i = pn.getRegExp(`(${r.map(e => e === `?` ? `\\?` : e).join(`|`)})`)
      , a = !i.test(e);
    if (!a) {
        let t = e.indexOf(n);
  ...
  , vn = new class e {
    ...
    forward(e, t, n, r) {
        return r && !this.debug ? null : (A(e[0]) && (e[0] = `${n}${this.prefix} ${e[0]}`),
        this.logger[t](e))
    }
    create(t) {
  ...
  , bn = class extends yn {
    ...
    getResource(e, t, n, r={}) {
        ...
        n && (Array.isArray(n) ? o.push(...n) : A(n) && i ? o.push(...n.split(i)) : o.push(n)));
        let s = an(this.data, o);
        return !s && !t && !n && e.indexOf(`.`) > -1 && (e = o[0],
        t = o[1],
        n = o.slice(2).join(`.`)),
        s || !a || !A(n) ? s : hn(this.data?.[e]?.[t], n, i)
    }
    ...
    addResources(e, t, n, r={
        ...
        for (let r in n)
            (A(n[r]) || Array.isArray(n[r])) && this.addResource(e, t, r, n[r], {
                silent: !0
            });
    ...
    getResourceBundle(e, t) {
        return t ||= this.options.defaultNS,
  ...
  , Sn = Symbol(`i18next/PATH_KEY`);
function Cn() {
    let e = [], t = Object.create(null), n;
    return t.get = (r, i) => (n?.revoke?.(),
    i === Sn ? e : (e.push(i),
    n = Proxy.revocable(r, t),
    n.proxy)),
...
var Tn = {}
  , En = e => !A(e) && typeof e != `boolean` && typeof e != `number`
  , Dn = class e extends yn {
    constructor(e, t={}) {
        super(),
        Zt([`resourceStore`, `languageUtils`, `pluralResolver`, `interpolator`, `backendConnector`, `i18nFormat`, `utils`], e, this),
        this.options = t,
        this.options.keySeparator === void 0 && (this.options.keySeparator = `.`),
    ...
    extractFromKey(e, t) {
        ...
        let r = t.keySeparator === void 0 ? this.options.keySeparator : t.keySeparator
          ...
          , a = n && e.indexOf(n) > -1
          , o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !mn(e, n, r);
        if (a && !o) {
    ...
    translate(t, n, r) {
        ...
        if (typeof i != `object` && this.options.overloadTranslationOptionHandler && (i = this.options.overloadTranslationOptionHandler(arguments)),
        typeof options == `object` && (i = {
            ...i
        }),
        i ||= {},
        t == null)
            return ``;
        typeof t == `function` && (t = wn(t, i)),
        ...
        let p = this.resolve(t, i)
          ...
          , b = i.count !== void 0 && !A(i.count)
          , x = e.hasDefaultValue(i)
          , ee = b ? this.pluralResolver.getSuffix(d, i.count, i) : ``
          , te = i.ordinal && b ? this.pluralResolver.getSuffix(d, i.count, {
            ordinal: !1
        }) : ``
          , ne = b && !i.ordinal && i.count === 0
          , re = ne && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${ee}`] || i[`defaultValue${te}`] || i.defaultValue
          , S = m;
        y && !m && x && (S = re);
        let ie = En(S)
          , ae = Object.prototype.toString.apply(S);
        if (y && S && ie && _.indexOf(ae) < 0 && !(A(v) && Array.isArray(S))) {
            if (!i.returnObjects && !this.options.returnObjects) {
                this.options.returnedObjectHandler || this.logger.warn(`accessing an object - but returnObjects options is not enabled!`);
                let e = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, S, {
                    ...i,
                    ns: c
                }) : `key '${s} (${this.language})' returned an object instead of string.`;
                return a ? (p.res = e,
                p.usedParams = this.getUsedParamsDetails(i),
                p) : e
            }
            if (o) {
                ...
                for (let e in S)
                    if (Object.prototype.hasOwnProperty.call(S, e)) {
                        ...
                        x && !m ? t[e] = this.translate(r, {
                            ...i,
                            defaultValue: En(re) ? re[e] : void 0,
                            joinArrays: !1,
                            ns: c
        ...
        } else if (y && A(v) && Array.isArray(m))
            m = m.join(v),
            m &&= this.extendTranslation(m, t, i, r);
        else {
            let e = !1
              , n = !1;
            !this.isValidLookup(m) && x && (e = !0,
            m = re),
            this.isValidLookup(m) || (n = !0,
            m = s);
            let a = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && n ? void 0 : m
              , c = x && re !== m && this.options.updateMissing;
            if (n || e || c) {
                if (this.logger.log(c ? `updateKey` : `missingKey`, d, l, s, c ? re : m),
                o) {
                ...
                let e = []
                  , t = this.languageUtils.getFallbackCodes(this.options.fallbackLng, i.lng || this.language);
                if (this.options.saveMissingTo === `fallback` && t && t[0])
                    for (let n = 0; n < t.length; n++)
                        e.push(t[n]);
                else
                    this.options.saveMissingTo === `all` ? e = this.languageUtils.toResolveHierarchy(i.lng || this.language) : e.push(i.lng || this.language);
                let n = (e, t, n) => {
                    let r = x && n !== m ? n : a;
                    this.options.missingKeyHandler ? this.options.missingKeyHandler(e, l, t, r, c, i) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing(e, l, t, r, c, i),
                ...
                this.options.saveMissing && (this.options.saveMissingPlurals && b ? e.forEach(e => {
                    ...
                    ne && i[`defaultValue${this.options.pluralSeparator}zero`] && t.indexOf(`${this.options.pluralSeparator}zero`) < 0 && t.push(`${this.options.pluralSeparator}zero`),
                    t.forEach(t => {
                        n([e], s + t, i[`defaultValue${t}`] || re)
                    }
                    )
                }
                ) : n(e, s, re))
            ...
            (n || e) && this.options.parseMissingKeyHandler && (m = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${l}${u}${s}` : s, e ? m : void 0, i))
        }
        return a ? (p.res = m,
        p.usedParams = this.getUsedParamsDetails(i),
        p) : m
    ...
    extendTranslation(e, t, n, r, i) {
        if (this.i18nFormat?.parse)
            ...
            let a = A(e) && (n?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : n.interpolation.skipOnVariables), o;
            if (a) {
                let t = e.match(this.interpolator.nestingRegexp);
                o = t && t.length
            }
            let s = n.replace && !A(n.replace) ? n.replace : n;
            ...
            n.nest !== !1 && (e = this.interpolator.nest(e, (...e) => i?.[0] === e[0] && !n.context ? (this.logger.warn(`It seems you are nesting recursively key: ${e[0]} in key: ${t[0]}`),
            null) : this.translate(...e, t), n)),
            n.interpolation && this.interpolator.reset()
        }
        let a = n.postProcess || this.options.postProcess
          , o = A(a) ? [a] : a;
        return e != null && o?.length && n.applyPostProcessor !== !1 && (e = xn.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
            i18nResolved: {
                ...r,
    ...
    resolve(e, t={}) {
        ...
        e.forEach(e => {
            ...
            let u = t.count !== void 0 && !A(t.count)
              , d = u && !t.ordinal && t.count === 0
              , f = t.context !== void 0 && (A(t.context) || typeof t.context == `number`) && t.context !== ``
              , p = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
            l.forEach(e => {
                this.isValidLookup(n) || (o = e,
                !Tn[`${p[0]}-${e}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (Tn[`${p[0]}-${e}`] = !0,
                this.logger.warn(`key "${r}" for languages "${p.join(`, `)}" won't get resolved as namespace "${o}" was not yet loaded`, `This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!`)),
                p.forEach(r => {
                    if (this.isValidLookup(n))
                        return;
                    a = r;
                    ...
                    if (this.i18nFormat?.addLookupKeys)
                        ...
                        if (u && (t.ordinal && e.indexOf(i) === 0 && o.push(c + e.replace(i, this.options.pluralSeparator)),
                        o.push(c + e),
                        d && o.push(c + n)),
                        f) {
                            let r = `${c}${this.options.contextSeparator || `_`}${t.context}`;
                            o.push(r),
                            u && (t.ordinal && e.indexOf(i) === 0 && o.push(r + e.replace(i, this.options.pluralSeparator)),
                            o.push(r + e),
                            d && o.push(r + n))
                        }
                    }
                    let s;
                    for (; s = o.pop(); )
                        this.isValidLookup(n) || (i = s,
                        n = this.getResource(r, e, s, t))
                }
                ))
            }
            )
    ...
    getUsedParamsDetails(e={}) {
        let t = [`defaultValue`, `ordinal`, `context`, `replace`, `lng`, `lngs`, `fallbackLng`, `ns`, `keySeparator`, `nsSeparator`, `returnObjects`, `returnDetails`, `joinArrays`, `postProcess`, `interpolation`]
          , n = e.replace && !A(e.replace)
          , r = n ? e.replace : e;
        if (n && e.count !== void 0 && (r.count = e.count),
    ...
    static hasDefaultValue(e) {
        for (let t in e)
            if (Object.prototype.hasOwnProperty.call(e, t) && t.substring(0, 12) === `defaultValue` && e[t] !== void 0)
                return !0;
        return !1
    }
}
  , On = class {
    ...
    formatLanguageCode(e) {
        if (A(e) && e.indexOf(`-`) > -1) {
            ...
            return t && this.options.lowerCaseLng && (t = t.toLowerCase()),
    ...
    getBestMatchFromCodes(e) {
        ...
        !t && this.options.supportedLngs && e.forEach(e => {
            ...
            t = this.options.supportedLngs.find(e => {
                if (e === r || !(e.indexOf(`-`) < 0 && r.indexOf(`-`) < 0) && (e.indexOf(`-`) > 0 && r.indexOf(`-`) < 0 && e.substring(0, e.indexOf(`-`)) === r || e.indexOf(r) === 0 && r.length > 1))
                    return e
            }
            )
        }
    ...
    getFallbackCodes(e, t) {
        ...
        if (!t)
            return e.default || [];
        let n = e[t];
        return n ||= e[this.getScriptPartFromCode(t)],
    ...
    toResolveHierarchy(e, t) {
        ...
        ;
        return A(e) && (e.indexOf(`-`) > -1 || e.indexOf(`_`) > -1) ? (this.options.load !== `languageOnly` && i(this.formatLanguageCode(e)),
        this.options.load !== `languageOnly` && this.options.load !== `currentOnly` && i(this.getScriptPartFromCode(e)),
        this.options.load !== `currentOnly` && i(this.getLanguagePartFromCode(e))) : A(e) && i(this.formatLanguageCode(e)),
        n.forEach(e => {
  ...
  , jn = class {
    ...
    getSuffixes(e, t={}) {
        let n = this.getRule(e, t);
        return n ||= this.getRule(`dev`, t),
        n ? n.resolvedOptions().pluralCategories.sort( (e, t) => kn[e] - kn[t]).map(e => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ``}${e}`) : []
    }
    getSuffix(e, t, n={}) {
  ...
  , Pn = class {
    ...
    resetRegExp() {
        let e = (e, t) => e?.source === t ? (e.lastIndex = 0,
        e) : new RegExp(t,`g`);
    ...
    interpolate(e, t, n, r) {
        let i, a, o, s = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, c = e => {
            if (e.indexOf(this.formatSeparator) < 0) {
                let i = Mn(t, s, e, this.options.keySeparator, this.options.ignoreJSONStructure);
            ...
            return this.format(Mn(t, s, a, this.options.keySeparator, this.options.ignoreJSONStructure), o, n, {
                ...r,
                ...t,
                interpolationkey: a
            })
        ...
        let l = r?.missingInterpolationHandler || this.options.missingInterpolationHandler
          , u = r?.interpolation?.skipOnVariables === void 0 ? this.options.interpolation.skipOnVariables : r.interpolation.skipOnVariables;
        return [{
            regex: this.regexpUnescape,
            safeValue: e => Nn(e)
        }, {
            regex: this.regexp,
            safeValue: e => this.escapeValue ? Nn(this.escape(e)) : Nn(e)
        }].forEach(t => {
            for (o = 0; i = t.regex.exec(e); ) {
                ...
                a === void 0)
                    ...
                    !A(a) && !this.useRawValueToEscape && (a = Xt(a));
                let s = t.safeValue(a);
                if (e = e.replace(i[0], s),
                u ? (t.regex.lastIndex += a.length,
    ...
    nest(e, t, n={}) {
        ...
        for (; r = this.nestingRegexp.exec(e); ) {
            ...
            a = a.replace && !A(a.replace) ? a.replace : a,
            a.applyPostProcessor = !1,
            delete a.defaultValue;
            let c = /{.*}/.test(r[1]) ? r[1].lastIndexOf(`}`) + 1 : r[1].indexOf(this.formatSeparator);
            if (c !== -1 && (s = r[1].slice(c).split(this.formatSeparator).map(e => e.trim()).filter(Boolean),
            r[1] = r[1].slice(0, c)),
            ...
            ``),
            s.length && (i = s.reduce( (e, t) => this.format(e, t, n.lng, {
                ...n,
  ...
  , Rn = class {
    ...
    init(e, t={
        ...
        let n = t.cacheInBuiltFormats ? In : Ln;
        this.formats = {
            number: n( (e, t) => {
    ...
    addCached(e, t) {
        this.formats[e.toLowerCase().trim()] = In(t)
    }
    format(e, t, n, r={}) {
        ...
        return i.reduce( (e, t) => {
            let {formatName: i, formatOptions: a} = Fn(t);
            if (this.formats[i]) {
                let t = e;
                try {
  ...
  , Bn = class extends yn {
    ...
    queueLoad(e, t, n, r) {
        ...
        return e.forEach(e => {
            ...
            t.forEach(t => {
                let o = `${e}|${t}`;
                !n.reload && this.store.hasResourceBundle(e, t) ? this.state[o] = 2 : this.state[o] < 0 || (this.state[o] === 1 ? a[o] === void 0 && (a[o] = !0) : (this.state[o] = 1,
                r = !1,
                a[o] === void 0 && (a[o] = !0),
                i[o] === void 0 && (i[o] = !0),
                s[t] === void 0 && (s[t] = !0)))
    ...
    loaded(e, t, n) {
        ...
        !t && n && this.store.addResourceBundle(i, a, n, void 0, void 0, {
            skipCopy: !0
        }),
        this.state[e] = t ? -1 : 2,
        t && n && (this.state[e] = 0);
        ...
        this.queue.forEach(n => {
            ...
            zn(n, e),
            t && n.errors.push(t),
            n.pendingCount === 0 && !n.done && (Object.keys(n.loaded).forEach(e => {
                o[e] || (o[e] = {});
                let t = n.loaded[e];
    ...
    prepareLoading(e, t, n={}, r) {
        if (!this.backend)
            ...
            r && r();
        A(e) && (e = this.languageUtils.toResolveHierarchy(e)),
        A(t) && (t = [t]);
...
e)
  ...
  , Gn = class e extends yn {
    ...
    init(e={}, t) {
        ...
        e = {}),
        e.defaultNS == null && e.ns && (A(e.ns) ? e.defaultNS = e.ns : e.ns.indexOf(`translation`) < 0 && (e.defaultNS = e.ns[0]));
        let n = Vn();
        this.options = {
            ...n,
            ...this.options,
        ...
        if (!this.options.isClone) {
            this.modules.logger ? vn.init(r(this.modules.logger), this.options) : vn.init(null, this.options);
            let e;
            e = this.modules.formatter ? this.modules.formatter : Rn;
            let t = new On(this.options);
            this.store = new bn(this.options.resources,this.options);
            let i = this.services;
            i.logger = vn,
            i.resourceStore = this.store,
            i.languageUtils = t,
            i.pluralResolver = new jn(t,{
                prepend: this.options.pluralSeparator,
                simplifyPluralSuffix: this.options.simplifyPluralSuffix
            }),
            this.options.interpolation.format && this.options.interpolation.format !== n.interpolation.format && this.logger.deprecate(`init: you are still using the legacy format function, please use the new approach: https://www.i18next.com/translation-function/formatting`),
            e && (!this.options.interpolation.format || this.options.interpolation.format === n.interpolation.format) && (i.formatter = r(e),
            i.formatter.init && i.formatter.init(i, this.options),
            this.options.interpolation.format = i.formatter.format.bind(i.formatter)),
            i.interpolator = new Pn(this.options),
            i.utils = {
                hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
            },
            i.backendConnector = new Bn(r(this.modules.backend),i.resourceStore,i,this.options),
        ...
        ;
        return this.options.resources || !this.options.initAsync ? a() : setTimeout(a, 0),
        i
    }
    loadResources(e, t=Un) {
        let n = t
          , r = A(e) ? e : this.language;
    ...
    use(e) {
        ...
        e.type === `postProcessor` && xn.addPostProcessor(e),
    ...
    changeLanguage(e, t) {
        ...
        let r = e => {
          ...
          , i = (i, a) => {
            a ? this.isLanguageChangingTo === e && (r(a),
          ...
          , a = t => {
            ...
            let n = A(t) ? t : t && t[0]
              , a = this.store.hasLanguageSomeTranslations(n) ? n : this.services.languageUtils.getBestMatchFromCodes(A(t) ? [t] : t);
            a && (this.language || r(a),
    ...
    getFixedT(e, t, n) {
        let r = (e, t, ...i) => {
            ...
            return a.keyPrefix && Array.isArray(e) ? s = e.map(e => (typeof e == `function` && (e = wn(e, t)),
            `${a.keyPrefix}${o}${e}`)) : (typeof e == `function` && (e = wn(e, t)),
            s = a.keyPrefix ? `${a.keyPrefix}${o}${e}` : e),
            this.t(s, a)
        }
        ;
        return A(e) ? r.lng = e : r.lngs = e,
        r.ns = t,
        r.keyPrefix = n,
        r
    }
    ...
    loadNamespaces(e, t) {
        let n = Yt();
        return this.options.ns ? (A(e) && (e = [e]),
        e.forEach(e => {
            this.options.ns.indexOf(e) < 0 && this.options.ns.push(e)
        }
        ),
    ...
    dir(e) {
        ...
        let t = `ar.shu.sqr.ssh.xaa.yhd.yud.aao.abh.abv.acm.acq.acw.acx.acy.adf.ads.aeb.aec.afb.ajp.apc.apd.arb.arq.ars.ary.arz.auz.avl.ayh.ayl.ayn.ayp.bbz.pga.he.iw.ps.pbt.pbu.pst.prp.prd.ug.ur.ydd.yds.yih.ji.yi.hbo.men.xmn.fa.jpr.peo.pes.prs.dv.sam.ckb`.split(`.`)
          , n = this.services?.languageUtils || new On(Vn());
    ...
    cloneInstance(t={}, n=Un) {
        ...
        r && (a.store = new bn(Object.keys(this.store.data).reduce( (e, t) => (e[t] = {
            ...this.store.data[t]
        },
        ...
        a.translator = new Dn(a.services,i),
        a.translator.on(`*`, (e, ...t) => {
            a.emit(e, ...t)
        }
        ),
  ...
  , j = Gn.createInstance();
j.createInstance = Gn.createInstance,
j.createInstance,
j.dir,
j.init,
j.loadResources,
...
j.loadNamespaces,
j.loadLanguages;
var Kn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g
  , qn = {
    "&amp;": `&`,
    "&#38;": `&`,
    "&lt;": `<`,
  ...
  , Qn = (0,
St.createContext)();
function $n({i18n: e, defaultNS: t, children: n}) {
    let r = (0,
    St.useMemo)( () => ({
        i18n: e,
        defaultNS: t
    ...
    return (0,
    St.createElement)(Qn.Provider, {
        value: r
    }, n)
}
var {slice: er, forEach: tr} = [];
function nr(e) {
    return tr.call(er.call(arguments, 1), t => {
        if (t)
            for (let n in t)
                e[n] === void 0 && (e[n] = t[n])
    }
...
function rr(e) {
    return typeof e == `string` ? [/<\s*script.*?>/i, /<\s*\/\s*script\s*>/i, /<\s*img.*?on\w+\s*=/i, /<\s*\w+\s*on\w+\s*=.*?>/i, /javascript\s*:/i, /vbscript\s*:/i, /expression\s*\(/i, /eval\s*\(/i, /alert\s*\(/i, /document\.cookie/i, /document\.write\s*\(/i, /window\.location/i, /innerHTML/i].some(t => t.test(e)) : !1
}
var ir = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/
  , ar = function(e, t) {
    ...
    return n.partitioned && (r += `; Partitioned`),
    r
}
  , or = {
    create(e, t, n, r) {
  ...
  , dr = () => {
    if (ur !== null)
        return ur;
    try {
        if (ur = typeof window < `u` && window.localStorage !== null,
        !ur)
            return !1;
  ...
  , fr = {
    ...
    cacheUserLanguage(e, t) {
        ...
        n && dr() && window.localStorage.setItem(n, e)
    }
}
  , pr = null
  , mr = () => {
    if (pr !== null)
        return pr;
    try {
        if (pr = typeof window < `u` && window.sessionStorage !== null,
        !pr)
            return !1;
        let e = `i18next.translate.boo`;
  ...
  , hr = {
    ...
    cacheUserLanguage(e, t) {
        ...
        n && mr() && window.sessionStorage.setItem(n, e)
    }
}
  , gr = {
    name: `navigator`,
...
var xr = [`querystring`, `cookie`, `localStorage`, `sessionStorage`, `navigator`, `htmlTag`];
br || xr.splice(1, 1);
var Sr = () => ({
    order: xr,
  ...
  , Cr = class {
    ...
    init() {
        ...
        this.services = e,
        this.options = nr(t, this.options || {}, Sr()),
        typeof this.options.convertDetectedLanguage == `string` && this.options.convertDetectedLanguage.indexOf(`15897`) > -1 && (this.options.convertDetectedLanguage = e => e.replace(`-`, `_`)),
    ...
    detect() {
        ...
        t = t.filter(e => e != null && !rr(e)).map(e => this.options.convertDetectedLanguage(e)),
            ...
            try {
                a: {
                    ...
                    try {
                        b: {
                            for (b(t),
                            d = n(c); d !== null && !(d.expirationTime > t && S()); ) {
                                var o = d.callback;
...
` + e.stack
    ...
    function tt(e, t, n) {
        ...
        return s === 0 ? (s = r & ~a,
        s === 0 ? o === 0 ? n || (n = r & ~e,
        n !== 0 && (i = et(n))) : i = et(o) : i = et(s)) : (r = s & ~a,
        r === 0 ? (o &= s,
        o === 0 ? n || (n = s & ~e,
        n !== 0 && (i = et(n))) : i = et(o)) : i = et(r)),
    ...
    var Nt = RegExp(`^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$`)
      ...
      , Ft = {};
    function It(e) {
        return Ae.call(Ft, e) ? !0 : Ae.call(Pt, e) ? !1 : Nt.test(e) ? Ft[e] = !0 : (Pt[e] = !0,
        !1)
    }
    function O(e, t, n) {
        if (It(t))
    ...
    function Ut(e) {
        ...
        var n = t.getValue()
          , r = ``;
        return e && (r = Bt(e) ? e.checked ? `true` : `false` : e.value),
        e = r,
        e === n ? !1 : (t.setValue(e),
        !0)
    }
    ...
    function Kt(e, t, n, r, i, a, o, s) {
        ...
        t == null ? o !== `submit` && o !== `reset` || e.removeAttribute(`value`) : o === `number` ? (t === 0 && e.value === `` || e.value != t) && (e.value = `` + zt(t)) : e.value !== `` + zt(t) && (e.value = `` + zt(t)),
        t == null ? n == null ? r != null && e.removeAttribute(`value`) : Jt(e, o, zt(n)) : Jt(e, o, zt(t)),
        i == null && a != null && (e.defaultChecked = !!a),
        i != null && (e.checked = i && typeof i != `function` && typeof i != `symbol`),
        s != null && typeof s != `function` && typeof s != `symbol` && typeof s != `boolean` ? e.name = `` + zt(s) : e.removeAttribute(`name`)
    }
    ...
    function dn(e) {
        ...
        if (t && (e = t.stateNode)) {
            ...
            t.type) {
            case `input`:
                if (Kt(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name),
                t = n.name,
                n.type === `radio` && t != null) {
                    for (n = e; n.parentNode; )
                        n = n.parentNode;
                    for (n = n.querySelectorAll(`input[name="` + k(`` + t) + `"][type="radio"]`),
                    t = 0; t < n.length; t++) {
                        var r = n[t];
    ...
    function sr(e, t) {
        if (ar)
            return e === `compositionend` || !Zn && rr(e, t) ? (e = xn(),
            bn = yn = vn = null,
            ar = !1,
            e) : null;
        switch (e) {
    ...
    function br() {
        dr && (dr.detachEvent(`onpropertychange`, xr),
        fr = dr = null)
    }
    function xr(e) {
    ...
    function Sr(e, t, n) {
        ...
        dr = t,
        fr = n,
        dr.attachEvent(`onpropertychange`, xr)) : e === `focusout` && br()
    }
    function Cr(e) {
    ...
    var Ir = hn && `documentMode`in document && 11 >= document.documentMode
      , Lr = null
      , Rr = null
      , zr = null
      , Br = !1;
    function Vr(e, t, n) {
        ...
        Br || Lr == null || Lr !== Wt(r) || (r = Lr,
        `selectionStart`in r && Fr(r) ? r = {
    ...
    var Ur = {
      ...
      , Wr = {}
      , Gr = {};
    hn && (Gr = document.createElement(`div`).style,
    ...
    function _i(e, t) {
        var n = e.alternate;
        return n === null ? (n = hi(e.tag, t, e.key, e.mode),
    ...
    function yi(e, t, n, r, a, o) {
        ...
        typeof e == `function`)
            ...
            case v:
                ...
                break;
            case y:
                return e = hi(12, n, t, a | 2),
                e.elementType = y,
                e.lanes = o,
                e;
            case te:
                return e = hi(13, n, t, a),
                e.elementType = te,
                e.lanes = o,
                e;
            case ne:
                return e = hi(19, n, t, a),
                e.elementType = ne,
                e.lanes = o,
                e;
            default:
    ...
    function Ci(e, t, n) {
        return t = hi(4, e.children === null ? [] : e.children, e.key, t),
        t.lanes = n,
        t.stateNode = {
    ...
    var Bi = null
      ...
      , Ui = Error(i(519));
    function Wi(e) {
        throw Xi(Ti(Error(i(418, 1 < arguments.length && arguments[1] !== void 0 && arguments[1] ? `text` : `HTML`, ``)), e)),
        Ui
    }
    function Gi(e) {
        var t = e.stateNode
    ...
    function qi(e) {
        ...
        t === 13) {
            ...
            Zd(e.type) ? (e = lf,
            lf = null,
            M = e) : M = t) : M = Bi ? cf(e.stateNode.nextSibling) : null;
        return !0
    }
    function Ji() {
        M = Bi = null,
    ...
    function aa(e) {
        for (e = e.firstContext; e !== null; ) {
            if (!Dr(e.context._currentValue, e.memoizedValue))
                return !0;
            e = e.next
        }
        return !1
    ...
    function Ha(e) {
        ...
        function c(e, t, n, r) {
            return t === null || t.tag !== 6 ? (t = xi(n, e.mode, r),
            t.return = e,
            t) : (t = a(t, n),
            t.return = e,
            t)
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === _ ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === S && Na(i) === t.type) ? (t = a(t, n.props),
            Ba(t, n),
            t.return = e,
            t) : (t = yi(n.type, n.key, n.props, null, e.mode, r),
            Ba(t, n),
            t.return = e,
            t)
        }
        function u(e, t, n, r) {
            return t === null || t.tag !== 4 || t.stateNode.containerInfo !== n.containerInfo || t.stateNode.implementation !== n.implementation ? (t = Ci(n, e.mode, r),
            t.return = e,
            t) : (t = a(t, n.children || []),
            t.return = e,
            t)
        ...
        function d(e, t, n, r, i) {
            return t === null || t.tag !== 7 ? (t = bi(n, e.mode, r, i),
            t.return = e,
            t) : (t = a(t, n),
            t.return = e,
            t)
        ...
        function f(e, t, n) {
            if (typeof t == `string` && t !== `` || typeof t == `number` || typeof t == `bigint`)
                return t = xi(`` + t, e.mode, n),
                t.return = e,
                t;
            if (typeof t == `object` && t) {
                switch (t.$$typeof) {
                case h:
                    return n = yi(t.type, t.key, t.props, null, e.mode, n),
                    Ba(n, t),
                    n.return = e,
                    n;
                case g:
        ...
        function b(e, r, o, c) {
            if (typeof o == `object` && o && o.type === _ && o.key === null && (o = o.props.children),
            typeof o == `object` && o) {
                switch (o.$$typeof) {
                case h:
                    a: {
                        for (var l = o.key; r !== null; ) {
                            if (r.key === l) {
                                ...
                                } else if (r.elementType === l || typeof l == `object` && l && l.$$typeof === S && Na(l) === r.type) {
                                    n(e, r.sibling),
                                    c = a(r, o.props),
                                    Ba(c, o),
                                    c.return = e,
                        ...
                        o.type === _ ? (c = bi(o.props.children, e.mode, c, o.key),
                        c.return = e,
                        e = c) : (c = yi(o.type, o.key, o.props, null, e.mode, c),
                        Ba(c, o),
                        c.return = e,
                        e = c)
                    }
    ...
    function Eo(e, t, n, r, i, a) {
        ...
        t.updateQueue = null,
        t.lanes = 0,
        C.H = e === null || e.memoizedState === null ? Hs : Us,
        bo = !1,
        a = n(r, i),
        bo = !1,
        yo && (a = Oo(t, n, r, i)),
    ...
    function No() {
        ...
        return R === null ? I.memoizedState = R = e : R = R.next = e,
        R
    }
    function B() {
        if (L === null) {
    ...
    function Fo(e) {
        ...
        e = Ma(Co, e, t),
        t = I,
        (R === null ? t.memoizedState : R.next) === null && (t = t.alternate,
        C.H = t === null || t.memoizedState === null ? Hs : Us),
        e
    }
    function Io(e) {
        if (typeof e == `object` && e) {
    ...
    function as(e, t, n) {
        ...
        var i = t.queue
          , a = i.dispatch;
        return n !== t.memoizedState && (I.flags |= 2048,
        cs(9, {
            destroy: void 0
    ...
    function ds(e, t, n, r) {
        ...
        L !== null && r !== null && To(r, L.memoizedState.deps) ? i.memoizedState = cs(t, a, n, r) : (I.flags |= e,
    ...
    function Cs(e, t, n) {
        return n === void 0 || _o & 1073741824 && !(J & 261930) ? e.memoizedState = t : (e.memoizedState = n,
        e = mu(),
        I.lanes |= e,
        Gl |= e,
        n)
    ...
    function ws(e, t, n, r) {
        return Dr(n, t) ? n : ro.current === null ? !(_o & 42) || _o & 1073741824 && !(J & 261930) ? (V = !0,
    ...
    var Hs = {
        ...
        useTransition: function() {
            var e = Jo(!1);
            return e = Ts.bind(null, I, e.queue, !0, !1),
            No().memoizedState = e,
            [!1, e]
        },
    ...
    var Ws = {
        ...
        useOptimistic: function(e, t) {
            var n = B();
            return L === null ? (n.baseState = e,
            [e, n.queue.dispatch]) : Yo(n, L, e, t)
        },
        useMemoCache: Lo,
        useCacheRefresh: Ms
    };
    ...
    function ic(e, t, n, r, a) {
        ...
        typeof r == `object` && r && typeof r.then == `function`) {
            ...
            n !== null) {
                ...
                case 31:
                case 13:
                    return lo === null ? Du() : n.alternate === null && X === 0 && (X = 3),
                    n.flags &= -257,
                    n.flags |= 65536,
                    n.lanes = a,
    ...
    function cc(e, t, n, r, i) {
        if (e === null) {
            var a = n.type;
            return typeof a == `function` && !gi(a) && a.defaultProps === void 0 && n.compare === null ? (t.tag = 15,
            t.type = a,
            lc(e, t, a, r, i)) : (e = yi(n.type, null, r, t, t.mode, i),
            e.ref = t.ref,
            e.return = t,
            t.child = e)
        }
    ...
    function yc(e, t, n, r, i) {
        ...
        t.stateNode === null) {
            ...
            $a(),
            l = t.memoizedState,
            s || f !== l || Ga ? (typeof d == `function` && (Gs(t, n, d, r),
            l = t.memoizedState),
            (c = Ga || qs(t, n, c, r, f, l, o)) ? (u || typeof a.UNSAFE_componentWillMount != `function` && typeof a.componentWillMount != `function` || (typeof a.componentWillMount == `function` && a.componentWillMount(),
            typeof a.UNSAFE_componentWillMount == `function` && a.UNSAFE_componentWillMount()),
            ...
            o !== d || f !== p || Ga || e !== null && e.dependencies !== null && aa(e.dependencies) ? (typeof s == `function` && (Gs(t, n, s, r),
            p = t.memoizedState),
            (u = Ga || qs(t, n, u, r, f, p, c) || e !== null && e.dependencies !== null && aa(e.dependencies)) ? (l || typeof a.UNSAFE_componentWillUpdate != `function` && typeof a.componentWillUpdate != `function` || (typeof a.componentWillUpdate == `function` && a.componentWillUpdate(r, p, c),
        ...
        t.child = Ua(t, null, n, i)) : oc(e, t, n, i),
    ...
    function wc(e, t, n) {
        ...
        if ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (F.current & 2) != 0),
        s && (a = !0,
        t.flags &= -129),
        s = (t.flags & 32) != 0,
        t.flags &= -33,
        ...
        c !== null)) {
            if (o)
                t.flags & 256 ? (uo(t),
                t.flags &= -257,
                t = Dc(e, t, n)) : t.memoizedState === null ? (mo(t),
                c = r.fallback,
                a = t.mode,
                r = Ec({
                    mode: `visible`,
    ...
    function Nc(e, t, n) {
        ...
        case 13:
            ...
            if (r !== null)
                ...
                e = jc(e, t, n),
                e === null ? null : e.sibling) : wc(e, t, n) : (uo(t),
                t.flags |= 128,
                null);
            uo(t);
            break;
    ...
    function Pc(e, t, n) {
        if (e !== null)
            ...
            V = !1,
            N && t.flags & 1048576 && Ii(t, ki, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            a: {
        ...
        case 27:
            return xe(t),
            e === null && N && (r = t.stateNode = ff(t.type, t.pendingProps, _e.current),
            Bi = t,
            Hi = !0,
            a = M,
            Zd(t.type) ? (lf = a,
            M = cf(r.firstChild)) : M = a),
            oc(e, t, t.pendingProps.children, n),
            gc(e, t),
            e === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return e === null && N && ((a = r = M) && (r = tf(r, t.type, t.pendingProps, Hi),
    ...
    function Rc(e, t) {
        t !== null && (e.flags |= 4),
        e.flags & 16384 && (t = e.tag === 22 ? 536870912 : it(),
        e.lanes |= t,
        Yl |= t)
    }
    function zc(e, t) {
    ...
    function Bc(e, t, n) {
        ...
        case 3:
            ...
            (e === null || e.child === null) && (qi(t) ? Fc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024,
            Yi())),
            H(t),
            null;
        case 26:
            ...
            o === null ? (H(t),
            Ic(t, a, null, r, n)) : (H(t),
            Lc(t, o))) : o ? o === e.memoizedState ? (H(t),
            ...
            o === null)
                        ...
                        for (e = t.child; e !== null; ) {
                            ...
                            o !== null) {
                                ...
                                n = t.child; n !== null; )
                                    vi(n, e),
                                    n = n.sibling;
                                return E(F, F.current & 1 | 2),
                                N && Fi(t, r.treeForkCount),
                                t.child
                            }
                            e = e.sibling
                        }
                    r.tail !== null && Fe() > tu && (t.flags |= 128,
                    a = !0,
                    zc(r, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    e !== null) {
                        ...
                        2 * Fe() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128,
                        a = !0,
                        zc(r, !1),
                        t.lanes = 4194304);
        ...
        case 23:
            ...
            r ? n & 536870912 && !(t.flags & 128) && (H(t),
            t.subtreeFlags & 6 && (t.flags |= 8192)) : H(t),
            n = t.updateQueue,
    ...
    function ml(e) {
        ...
        case 19:
            var t = e.stateNode;
            return t === null && (t = e.stateNode = new il),
            t;
        case 22:
            return e = e.stateNode,
            t = e._retryCache,
    ...
    function vl(e, t) {
                        ...
                        if (e.stateNode === null) {
                            a: {
                                ...
                                case `title`:
                                    ...
                                    (!o || o[Ct] || o[gt] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r),
        ...
        case 13:
            gl(t, e),
            yl(e),
            e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && ($l = Fe()),
            r & 4 && (r = e.updateQueue,
            r !== null && (e.updateQueue = null,
            hl(e, r)));
            break;
    ...
    function Dl(e, t, n, r) {
        ...
        case 22:
            a = t.stateNode,
            o = t.alternate,
            t.memoizedState === null ? a._visibility & 2 ? El(e, t, n, r) : (a._visibility |= 2,
            Ol(e, t, n, r, (t.subtreeFlags & 10256) != 0 || !1)) : a._visibility & 2 ? El(e, t, n, r) : kl(e, t),
            i & 2048 && wl(o, t);
            break;
        case 24:
            El(e, t, n, r),
            i & 2048 && Tl(t.alternate, t);
            break;
        default:
            El(e, t, n, r)
        }
    ...
    function Ol(e, t, n, r, i) {
        ...
        t = t.child; t !== null; ) {
            ...
            case 22:
                ...
                Ol(a, o, s, c, i)) : u._visibility & 2 ? Ol(a, o, s, c, i) : kl(a, o),
    ...
    function Ml(e, t, n) {
        ...
        case 22:
            ...
            r !== null && r.memoizedState !== null ? (r = Al,
            Al = 16777216,
            jl(e, t, n),
            Al = r) : jl(e, t, n));
            break;
    ...
    function hu(e, t, n) {
        (e === K && (Y === 2 || Y === 9) || e.cancelPendingCommit !== null) && (Su(e, 0),
        yu(e, J, Jl, !1)),
        ot(e, n),
        (!(G & 2) || e !== K) && (e === K && (!(G & 2) && (Kl |= n),
        X === 4 && yu(e, J, Jl, !1)),
        rd(e))
    }
    function gu(e, t, n) {
    ...
    function Cu(e, t) {
        ...
        t === Da || t === ka ? (t = Fa(),
        Y = 3) : t === Oa ? (t = Fa(),
        Y = 4) : Y = t === ac ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1,
        Bl = t,
        q === null && (X = 1,
        $s(e, Ti(t, e.current)))
    }
    ...
    function Pu(e, t, n, r) {
        ...
        t.flags & 32768 ? (N || r === 1 ? e = !0 : Hl || J & 536870912 ? e = !1 : (Vl = e = !0,
    ...
    function Ku(e, t, n) {
        ...
        e.warmLanes &= ~n,
        K === e && (J & n) === n && (X === 4 || X === 3 && (J & 62914560) === J && 300 > Fe() - $l ? !(G & 2) && Su(e, 0) : ql |= n,
        Yl === J && (Yl = 0)),
        rd(e)
    }
    function qu(e, t) {
    ...
    function sd(e, t) {
        for (var n = e.suspendedLanes, r = e.pingedLanes, i = e.expirationTimes, a = e.pendingLanes & -62914561; 0 < a; ) {
            var o = 31 - qe(a)
              , s = 1 << o
              , c = i[o];
            c === -1 ? ((s & n) === 0 || (s & r) !== 0) && (i[o] = rt(s, t)) : c <= t && (e.expiredLanes |= s),
            a &= ~s
        }
        if (t = K,
        n = J,
    ...
    function cd(e, t) {
        ...
        if (Hu() && e.callbackNode !== n)
            return null;
        var r = J;
        return r = tt(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r === 0 ? null : (gu(e, r, t),
        sd(e, Fe()),
    ...
    function md(e, t, n, r, i) {
        if (t === `submit` && n && n.stateNode === i) {
            var a = fd((i[_t] || null).action)
              , o = r.submitter;
            o && (t = (t = o[_t] || null) ? fd(t.formAction) : o.getAttribute(`formAction`),
            t !== null && (a = t,
            o = null));
        ...
        pn(function() {
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    c && n !== sn && (u = n.relatedTarget || n.fromElement) && (Tt(u) || u[vt]))
                        break a;
                    ...
                    l !== u)) {
                        ...
                        p = `onMouseEnter`,
                        m = `mouse`,
                        (e === `pointerout` || e === `pointerover`) && (d = j,
                        g = `onPointerLeave`,
                        p = `onPointerEnter`,
                        m = `pointer`),
                        f = l == null ? c : Dt(l),
                ...
                a: {
                    ...
                    l === `select` || l === `input` && c.type === `file`)
                        ...
                        l = c.nodeName,
                        !l || l.toLowerCase() !== `input` || c.type !== `checkbox` && c.type !== `radio` ? r && tn(r.elementType) && (v = hr) : v = wr;
                    if (v &&= v(e, r)) {
                        ur(s, v, n, i);
                        break a
                    }
                    y && y(e, c, r),
                    e === `focusout` && r && c.type === `number` && r.memoizedProps.value != null && Jt(c, `number`, c.value)
                }
                switch (y = r ? Dt(r) : window,
                e) {
                case `focusin`:
                    (lr(y) || y.contentEditable === `true`) && (Lr = y,
                    Rr = r,
                    zr = null);
                    break;
                case `focusout`:
                ...
                if (Zn)
                    ...
                    ar ? rr(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);
                x && (er && n.locale !== `ko` && (ar || x !== `onCompositionStart` ? x === `onCompositionEnd` && ar && (b = xn()) : (vn = i,
                ...
                b ? x.data = b : (b = ir(n),
                b !== null && (x.data = b)))),
                (b = $n ? or(e, n) : sr(e, n)) && (x = Ed(r, `onBeforeInput`),
    ...
    function Od(e, t, n, r, i) {
        for (var a = t._reactName, o = []; n !== null && n !== r; ) {
            ...
            i ? (l = mn(n, a),
            l != null && o.unshift(Td(n, l, c))) : i || (l = mn(n, a),
...
`).replace(Ad, ``)
        ...
        default:
            if (!At.hasOwnProperty(n))
                a: {
                    ...
                    n in e ? e[n] = r : !0 === r ? e.setAttribute(n, ``) : O(e, n, r)
                }
        }
    }
    function Pd(e, t, n) {
        ...
        case `select`:
            ...
            n = s,
            e.multiple = !!r,
            t == null ? n != null && A(e, !!r, n, !0) : A(e, !!r, t, !1);
            return;
        case `textarea`:
    ...
    function Fd(e, t, n, r) {
        ...
        case `select`:
            ...
            n = s,
            r = m,
            p == null ? !!r != !!n && (t == null ? A(e, !!n, n ? [] : ``, !1) : A(e, !!n, t, !0)) : A(e, !!n, p, !1);
            return;
        case `textarea`:
            for (c in m = p = null,
            n)
    ...
    function wf(e, t, n) {
        ...
        var r = bf;
        if (r && e && t) {
            var i = `link[rel="preload"][as="` + k(t) + `"]`;
            t === `image` && n && n.imageSrcSet ? (i += `[imagesrcset="` + k(n.imageSrcSet) + `"]`,
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + k(n.imageSizes) + `"]`)) : i += `[href="` + k(e) + `"]`;
            var a = i;
            switch (t) {
            case `style`:
                a = Af(e);
    ...
    function Tf(e, t) {
        ...
        if (n && e) {
            var r = t && typeof t.as == `string` ? t.as : `script`
              , i = `link[rel="modulepreload"][as="` + k(r) + `"][href="` + k(e) + `"]`
              , a = i;
            switch (r) {
            case `audioworklet`:
            case `paintworklet`:
    ...
    function If(e, t, n) {
        ...
        t.instance === null)
            switch (t.type) {
            case `style`:
                var r = e.querySelector(`style[data-href~="` + k(n.href) + `"]`);
                if (r)
                    return t.instance = r,
                    D(r),
                    r;
...
function Ir() {
    ...
    return (0,
    St.useEffect)( () => {
        window.REACT_APP_NAVIGATE = n,
        Pr(window.REACT_APP_NAVIGATE)
    }
    ),
    t
}
function Lr() {
    ...
    Ct.jsx)($n, {
        ...
        children: (0,
        Ct.jsx)(s, {
            basename: `/preview/9deabda6-5e99-4d9b-9ff8-10c23eeccb75/10010999`,
            children: (0,
            Ct.jsx)(Ir, {})
        })
    })
...
(0,
Mr.createRoot)(document.getElementById(`root`)).render((0,
Ct.jsx)(St.StrictMode, {
    children: (0,
    Ct.jsx)(Lr, {})
}));
//# sourceMappingURL=index-C0cX_gIT.js.map
